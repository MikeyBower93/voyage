      ...
      "secrets": [
        {
          ...
          "valueFrom": "${aws_secretsmanager_secret_version.service_secret_version.arn}:SECRET_KEY_BASE::"
        },
        {
          "name": "DATABASE_URL",
          "valueFrom": "${aws_secretsmanager_secret_version.service_secret_version.arn}:DATABASE_URL::"
        }
      ],
      "mountPoints": [],
      "volumesFrom": [],
